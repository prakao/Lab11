...
int drawCard(void){
	int i = rand()%13+1;//Write the function to random the number from 1 to 13 and return that random number.
	return i;//srand() is used in main(). Do not use srand() here.
}
